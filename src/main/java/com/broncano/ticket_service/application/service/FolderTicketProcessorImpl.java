...
import com.broncano.ticket_service.domain.model.TicketFile;
import com.broncano.ticket_service.domain.model.TicketInvoice;
import com.broncano.ticket_service.domain.port.out.TicketGoogleDrivePort;
...
public class FolderTicketProcessorImpl implements FolderTicketProcessor {
     ...
     */
    public FolderTicketProcessorImpl(TicketGoogleDrivePort ticketGoogleDrivePort, TicketInvoiceExtractor ticketInvoiceExtractor, TicketInvoicePolicy ticketInvoicePolicy) {
    ...
    public List<TicketInvoice> process(String folderName) {
        ...
        try {
            Optional<String> folderId = ticketGoogleDrivePort.findFolderIdByName(folderName);
            ...
            if (pdfFiles.isEmpty()) {
                log.info("No se entraron PDFs en la carpeta: {}", folderName);
                return List.of();
            }
